...
REM
REM Generated by Vivado on Fri May 01 22:45:06 -0400 2026
...
echo "xvhdl --incr --relax -prj tb_feature_extract_vhdl.prj"
call xvhdl  --incr --relax -prj tb_feature_extract_vhdl.prj -log xvhdl.log
