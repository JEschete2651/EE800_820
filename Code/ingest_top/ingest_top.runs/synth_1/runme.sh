...
HD_PWD='D:/judee/Google Drive/School/Classes/EE800_820/Code/ingest_top/ingest_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ingest_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ingest_top.tcl
