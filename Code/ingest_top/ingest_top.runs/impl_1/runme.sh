...
HD_PWD='D:/judee/Google Drive/School/Classes/EE800_820/Code/ingest_top/ingest_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ingest_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ingest_top.tcl -notrace
