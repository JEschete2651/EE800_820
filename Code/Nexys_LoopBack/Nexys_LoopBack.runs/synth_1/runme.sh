...
HD_PWD='D:/judee/Google Drive/School/Classes/EE800_820/Code/Nexys_LoopBack/Nexys_LoopBack.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loopback_top.tcl
