...
HD_PWD='D:/judee/Google Drive/School/Classes/EE800_820/Code/Nexys_LoopBack/Nexys_LoopBack.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source loopback_top.tcl -notrace
