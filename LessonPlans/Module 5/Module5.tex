...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{tcolorbox}[colback=lightgray, colframe=darkgray, width=0.85\textwidth, arc=2pt]
			...
			project. Students subject the complete end-to-end system---beacon array, \RF{} link,
			\FPGA{} processing pipeline, and \ML{} classification---to sustained stress tests,
	...
	\begin{table}[ht!]
		...
		\begin{tabularx}{\textwidth}{c l X c}
			...
			3 & Beacon Firmware & STM32CubeIDE project; SPI driver, packet builder, scheduler. & $\square$ \\
			4 & Receiver Firmware & STM32CubeIDE project; ISR, ring buffer, UART forwarder. & $\square$ \\
	...
	\begin{enumerate}[leftmargin=2em]
		...
		\item \textbf{Software Setup:} Installation instructions for STM32CubeIDE, Vivado (WebPACK), Python environments, and all library dependencies. Specify exact version numbers that were tested.
	...
	\begin{table}[ht!]
		...
		\begin{tabularx}{\textwidth}{l l X}
			...
			STM32CubeIDE & Latest & Beacon/receiver firmware \\
