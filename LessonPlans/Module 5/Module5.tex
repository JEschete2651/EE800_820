...
\begin{document}
	...
	The module spans two calendar weeks and four working sessions. Throughout this document, ``Week~1'' through ``Week~4'' refer to \emph{session indices}, not calendar weeks: Week~1 and Week~2 are the two sessions of the first calendar week; Week~3 and Week~4 are the two sessions of the second calendar week. The first calendar week focuses on stress testing and benchmarking; the second focuses on failure analysis, documentation, and presentation.
