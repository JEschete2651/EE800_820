% Shared preamble for Module 4 lab handouts.
...
% ── Colors (match Module 4 lesson plan) ──────────────────────
...
% ── Listings style (Python code throughout Module 4) ─────────
\lstset{
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{darkgray}{Module 4 --- Lab Handout \labid}}
...
\newcommand{\labheader}[2]{%
	\begin{center}
		...
		{\small\color{darkgray} Capstone --- Module 4: AI-Driven Classification Pipeline}
	\end{center}
	\vspace{4pt}
