% Shared preamble for Module 3 lab handouts.
...
% ── Colors (match Module 3 lesson plan) ──────────────────────
...
% ── Listings style (Python code in LH3-F onwards) ────────────
\lstset{
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{darkgray}{Module 3 --- Lab Handout \labid}}
...
\newcommand{\labheader}[2]{%
	\begin{center}
		...
		{\small\color{darkgray} Capstone --- Module 3: System Integration and Data Collection}
	\end{center}
	\vspace{4pt}
