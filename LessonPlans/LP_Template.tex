...
\begin{document}
	...
	\begin{table}[ht!]
		\centering
		\caption{Module weekly breakdown.}
		\label{tab:schedule}
		...
		\begin{tabularx}{\textwidth}{c l X}
			...
			\midrule
			1 & Topic 1 & Detailed description of activities for Week 1. \\
			2 & Topic 2 & Detailed description of activities for Week 2. \\
			3 & Topic 3 & Detailed description of activities for Week 3. \\
			4 & Topic 4 & Detailed description of activities for Week 4. \\
			\bottomrule
		\end{tabularx}
	\end{table}
	...
	Additional sections for weeks 3, 4, etc. can be copied from the structure above.
	...
	\begin{table}[ht!]
		...
		\begin{tabularx}{\textwidth}{X c c}
			...
			\midrule
			Deliverable 1 & XX\% & Date or Week \\
			Deliverable 2 & XX\% & Date or Week \\
			\bottomrule
		\end{tabularx}
	\end{table}
