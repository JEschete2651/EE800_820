...
\labfigure{LH1C_spi_config.png}{0.85\textwidth}{STM32CubeMX \SPI{}1 parameter panel configured per Table~\ref{tab:spi-bringup}: 8-bit data, MSB first, \mbox{CPOL}=0, \mbox{CPHA}=1~Edge, prescaler chosen for $\leq$5\,MHz clock.}{fig:lh1c-cubemx}
