...
\section{Objective}
Transform a bag of loose parts (Adafruit RFM95W breakout, 0.1\,\textquotedbl{} header strip, 915\,MHz spring antenna) into a breadboard-ready, power-verified \RF{} module. The RFM95W breakout is built around the Semtech SX1276 transceiver that you will control directly in Lab Handout~1-C. By the end of this handout you will have a physically assembled breakout that draws the correct idle current and is ready for \SPI{} bring-up in Lab Handout~1-C.
