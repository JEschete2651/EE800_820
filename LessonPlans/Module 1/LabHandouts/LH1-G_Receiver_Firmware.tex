...
\labfigure{LH1G_frame_layout.png}{0.9\textwidth}{43-byte forwarding frame layout with delimiter, length, beacon payload, \RSSI{}/\SNR{}, timestamp, and trailing \CRC{}-16 highlighted.}{fig:lh1g-frame}
...
\labfigure{LH1G_python_parser_output.png}{0.85\textwidth}{Host-side \texttt{pyserial} parser output: 43-byte frames captured, start delimiter matched, \CRC{}-16 validated, beacon \mbox{ID}/sequence/\RSSI{}/\SNR{} extracted.}{fig:lh1g-parser}
