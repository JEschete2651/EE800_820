...
\labfigure{LH1E_vivado_installer.png}{0.85\textwidth}{Vivado installer device-family selection screen with \textbf{Artix-7} and \textbf{7~Series} checked. Deselecting other families saves tens of GB.}{fig:lh1e-installer}
...
\labfigure{LH1E_part_selection.png}{0.85\textwidth}{Vivado ``Default Part'' dialog with \texttt{xc7a100tcsg324-1} highlighted. Any other part will fail implementation on the Nexys A7-100T.}{fig:lh1e-part}
...
\labfigure{LH1E_utilization.png}{0.85\textwidth}{Post-implementation utilization report. Expect single-digit \mbox{LUT} usage out of 63{,}400 --- the synthesizer optimizes the direct assignment to trivial routing.}{fig:lh1e-util}
...
\labfigure{LH1E_hw_manager.png}{0.85\textwidth}{Vivado Hardware Manager after Auto Connect, showing the detected XC7A100T on the USB-JTAG link.}{fig:lh1e-hwm}
...
\labfigure{LH1E_board_leds.jpg}{0.65\textwidth}{Nexys A7 with two slide switches up and the corresponding \mbox{LED}s lit. The DONE \mbox{LED} should also be illuminated.}{fig:lh1e-board}
