% Shared preamble for Module 2 lab handouts.
...
% ── Colors (match Module 2 lesson plan) ──────────────────────
...
% ── Listings style (C / VHDL / Tcl / CMake / Python code blocks) ────
\lstset{
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{darkgray}{Module 2 --- Lab Handout \labid}}
...
% ── Figure helper: draws a placeholder box if the image file is missing ─
...
\newcommand{\labheader}[2]{%
	\begin{center}
		...
		{\small\color{darkgray} Capstone --- Module 2: \FPGA{} \RTL{} Design and Signal Ingestion}
	\end{center}
	\vspace{4pt}
